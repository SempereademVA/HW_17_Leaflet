    ...
    return function(t) {
        ...
        L.Timeline = L.GeoJSON.extend({
            ...
            initialize: function(t) {
                ...
                this.options.getInterval && (this._getInterval = function() {
                    var t;
            ...
            _process: function(t) {
                ...
                t.features.forEach(function(t) {
                    ...
                    r && (e.ranges.insert(r.start, r.end, t),
                ...
                0 !== this.times.length && (this.times.sort(function(t, e) {
                    return t - e
                }),
                this.times = this.times.reduce(function(t, e, n) {
                    if (0 === n)
                        return t;
                    var i = t[t.length - 1];
                    return i !== e && t.push(e),
            ...
            updateDisplayedLayers: function() {
                for (var t = this, e = this.ranges.lookup(this.time), n = 0; n < this.getLayers().length; n++) {
    ...
    , function(t, e, n) {
        ...
        L.TimelineSliderControl = L.Control.extend({
            ...
            _getTimes: function() {
                var t = this
                  , e = [];
                if (this.timelines.forEach(function(n) {
            ...
            _recalculate: function() {
                ...
                e || (this.end = r,
                this._timeSlider.max = r === -(1 / 0) ? 0 : r),
            ...
            _nearestEventTime: function(t) {
                for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = this._getTimes(), i = !1, r = n[0], o = 1; o < n.length; o++) {
                    var a = n[o];
                    if (i)
                        return a;
                    if (a >= t) {
            ...
            _createDOM: function() {
                var t = ["leaflet-control-layers", "leaflet-control-layers-expanded", "leaflet-timeline-control"]
                  , e = L.DomUtil.create("div", t.join(" "));
                if (this.container = e,
                this.options.enablePlayback) {
            ...
            _makeOutput: function(t) {
                this._output = L.DomUtil.create("output", "time-text", t),
            ...
            _sliderChanged: function(t) {
                ...
                this.time = e,
                this.options.waitToUpdateMap && "change" !== t.type || this.timelines.forEach(function(t) {
                    return t.setTime(e)
                }),
                this._output && (this._output.innerHTML = this.options.formatOutput(e))
            },
            _resetIfTimelinesChanged: function(t) {
                this.timelines.length !== t && (this._recalculate(),
            ...
            addTimelines: function() {
                var t = this;
                this.pause();
                for (var e = this.timelines.length, n = arguments.length, i = Array(n), r = 0; r < n; r++)
                    i[r] = arguments[r];
            ...
            play: function() {
                var t = this;
                clearTimeout(this._timer),
                parseFloat(this._timeSlider.value, 10) === this.end && (this._timeSlider.value = this.start),
                this._timeSlider.value = parseFloat(this._timeSlider.value, 10) + this._stepSize,
                this.setTime(this._timeSlider.value),
                parseFloat(this._timeSlider.value, 10) === this.end ? (this._playing = !1,
                this.container.classList.remove("playing")) : (this._playing = !0,
            ...
            return o(t, [{
                ...
                value: function(t, e, n, i, r, o) {
                    ...
                    if (null === i)
                        ...
                        var l = t < i.low || t === i.low && e < i.high ? "left" : "right";
                ...
                value: function(t, e, n) {
                    this._insert(t, e, n, this._root, this._root),
                    this.size++
                }
            }, {
                key: "lookup",
                value: function(t) {
                    var e = []
                      , n = this._root;
                    return 2 === arguments.length && (n = arguments[1]),
                    null === n || n.max < t ? e : (e.push.apply(e, i(this.lookup(t, n.left))),
                    n.low <= t && (n.high >= t && e.push(n.data),
